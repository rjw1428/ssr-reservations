  ...
  onRemove(user: User) {
    ...
    this.dialog.open(GenericPopupComponent, {
      data: {
        ...
        actionLabel: "Remove",
        action: () => this.store.dispatch(UserAccountActions.updateUserData({ userData }))
      }
    })
  }
